...
export default function EtiquetaDetalleScreen() {
  const { nombre } = useLocalSearchParams(); // Captura el ID/Nombre seleccionado

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Etiqueta Seleccionada</Text>
      <View style={styles.card}>
        <Text style={styles.detailText}>ID de Etiqueta: {nombre}</Text>
      </View>
    </View>
  );
}
